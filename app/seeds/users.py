...
def seed_videos():
    ...
    video4 = Video(user_id=4, title='Myth\'s Bad Ending Part 1', mp4='Myth_bad_ending_pt1.mp4', description='HoloMyth fan animation', created_at=date.today(), updated_at = date.today())
    video5 = Video(user_id=4, title='Myth\'s Bad Ending Part 2', mp4='Myth_bad_ending_pt2.mp4', description='HoloMyth fan animation', created_at=date.today(), updated_at = date.today())
