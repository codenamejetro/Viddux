...
def seed_videos():
    ...
    video4 = Video(user_id=4, title='Myth\'s Bad Ending Part 1', mp4='https://www.youtube.com/watch?v=euPfAilSpuU&t=413s', description='HoloMyth fan animation', created_at=date.today(), updated_at = date.today())
    video5 = Video(user_id=4, title='Myth\'s Bad Ending Part 2', mp4='https://www.youtube.com/watch?v=euPfAilSpuU&t=413s', description='HoloMyth fan animation', created_at=date.today(), updated_at = date.today())
